...
export const postJob = async (req, res) => {
    ...
    if (!companyId) {
        return res.json({ success: false, message: 'Company not authenticated' });
    }
    ...
    try {
        ...
        await newJob.save();
        res.json({ success: true, newJob, message: 'Job Created Successfully' });
    } catch (error) {
        res.json({ success: false, message: error.message });
    }
};

// get a comapn job applicants
